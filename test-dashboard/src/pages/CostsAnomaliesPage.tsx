...
const CostsAnomaliesPage: React.FC = () => {
  ...
  const handleSubmit = async (formData: Record<string, any>) => {
    try {
      setLoading(true);
      setError(null);
      const result = await apiPost('/api/costs/anomalies', formData);
      setData(result);
    } catch (err) {
  ...
  return (
    <div>
      ...
      <p>Detect unusual spending patterns using AWS Cost Anomaly Detection.</p>
      <p><strong>Endpoint:</strong> <code>POST /api/costs/anomalies</code></p>
...
export default CostsAnomaliesPage;
